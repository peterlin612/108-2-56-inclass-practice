...
```{r ans11}
ordered(factor(studentHeights$`學年度` , decreasing=T))
ordered(factor(studentHeights$`年齡`, decreasing=T))
...
average912 <- mean(studentHeights$`平均身高`[pick_912])  
...
```{r ans14}
a <- mean(studentHeights$`平均身高`[studentHeights$`類別`[studentHeights$`平均身高`[pick_68]] == "男"]) - mean(studentHeights$`平均身高`[studentHeights$`類別`[studentHeights$`平均身高`[pick_68]] == "女"]) 

b <- mean(studentHeights$`平均身高`[studentHeights$`類別`[studentHeights$`平均身高`[pick_912]] == "男"]) - mean(studentHeights$`平均身高`[studentHeights$`類別`[studentHeights$`平均身高`[pick_912]] == "女"]) 

c <- mean(studentHeights$`平均身高`[studentHeights$`類別`[studentHeights$`平均身高`[pick_1315]] == "男"]) - mean(studentHeights$`平均身高`[studentHeights$`類別`[studentHeights$`平均身高`[pick_1315]] == "女"]) 
...
```{r ans23}
bSchoolRegex <- c("^金[:graph:]+|^休[:graph:]+")
...
```{r ans24}
str_replace(differentMajors,"^不動[:graph:]+","不動系") -> differentMajors
str_replace(differentMajors,"^金[:graph:]+","金融系") -> differentMajors
str_replace(differentMajors,"^休[:graph:]+","休運系") -> differentMajors
str_replace(differentMajors,"^公[:graph:]+","公行系") -> differentMajors
str_replace(differentMajors,"社會工作學系","社工系") -> differentMajors
str_replace(differentMajors,"社會學系","社會系") -> differentMajors
str_replace(differentMajors,"經濟學系","經濟系") -> differentMajors
...
```{r ans25}
factor(differentMajors) -> school
str_replace(school,"休運系|金融系","商學院") -> school
str_replace(school,"經濟系|社會系|社工系","社科院") -> school
str_replace(school,"公行系|不動系","公共事務學院") -> school
